...
internal sealed class AsyncFuncImpl3<T1, T2, T3, T4, T5, T6, TResult> : IAsyncValueFunc<T1, T2, T3, T4, T5, T6, TResult>
{
    private readonly Func<T1, T2, T3, T4, T5, T6, TResult> func;

    internal AsyncFuncImpl3(Func<T1, T2, T3, T4, T5, T6, TResult> func)
        =>
        this.func = func;
