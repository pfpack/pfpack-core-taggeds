...
partial class AsyncValueFuncTests2
{
    ...
    {
        var sourceFunc = (Func<int?, object?, RefType?, RefType, StructType, DateTime, int, RecordType, DateTimeKind, RecordType?, object, string, long, object, ValueTask<RecordType>>)null!;
