...
internal sealed class AsyncValueFuncImpl3<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> : IAsyncValueFunc<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>
{
    private readonly Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> func;

    internal AsyncValueFuncImpl3(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> func)
        =>
        this.func = func;
