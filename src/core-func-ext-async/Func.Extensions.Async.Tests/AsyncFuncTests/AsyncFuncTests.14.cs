...
partial class AsyncFuncTests
{
    ...
    {
        var sourceFunc = (Func<int?, object?, RefType?, RefType, StructType, DateTime, int, RecordType, DateTimeKind, RecordType?, object, string, long, object, CancellationToken, Task<RecordType>>)null!;
