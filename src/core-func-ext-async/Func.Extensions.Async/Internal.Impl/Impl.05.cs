...
internal sealed class AsyncFuncImpl<T1, T2, T3, T4, T5, TResult> : IAsyncFunc<T1, T2, T3, T4, T5, TResult>
{
    private readonly Func<T1, T2, T3, T4, T5, CancellationToken, Task<TResult>> funcAsync;

    internal AsyncFuncImpl(Func<T1, T2, T3, T4, T5, CancellationToken, Task<TResult>> funcAsync)
        =>
