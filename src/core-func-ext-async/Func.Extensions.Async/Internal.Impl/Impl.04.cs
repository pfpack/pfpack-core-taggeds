...
internal sealed class AsyncFuncImpl<T1, T2, T3, T4, TResult> : IAsyncFunc<T1, T2, T3, T4, TResult>
{
    private readonly Func<T1, T2, T3, T4, CancellationToken, Task<TResult>> funcAsync;

    internal AsyncFuncImpl(Func<T1, T2, T3, T4, CancellationToken, Task<TResult>> funcAsync)
        =>
