...
internal sealed class AsyncValueFuncImpl<T1, T2, T3, T4, T5, T6, TResult> : IAsyncValueFunc<T1, T2, T3, T4, T5, T6, TResult>
{
    private readonly Func<T1, T2, T3, T4, T5, T6, CancellationToken, ValueTask<TResult>> funcAsync;

    internal AsyncValueFuncImpl(Func<T1, T2, T3, T4, T5, T6, CancellationToken, ValueTask<TResult>> funcAsync)
        =>
