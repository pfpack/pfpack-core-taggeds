...
internal sealed class FuncImpl<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> : IFunc<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult>
{
    private readonly Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> func;

    internal FuncImpl(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> func)
        =>
        this.func = func;
