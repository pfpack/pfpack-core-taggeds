...
namespace PrimeFuncPack.Core.Tests
{
    partial class FuncTest
    {
        ...
        public void Create_12_ThenInvoke_ExpectResultOfSourceFunc(
            RecordType? sourceFuncResult)
        {
            var actual = Func.Create<RecordType, RefType, int, string?, StructType, RefType, RecordType, decimal?, RecordType?, RefType, long, int, RecordType?>(
