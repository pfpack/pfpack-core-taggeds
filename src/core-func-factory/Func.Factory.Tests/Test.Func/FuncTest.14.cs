...
namespace PrimeFuncPack.Core.Tests
{
    partial class FuncTest
    {
        ...
        public void Create_14_ThenInvoke_ExpectResultOfSourceFunc(
            RecordType? sourceFuncResult)
        {
            var actual = Func.Create<string, int, StructType, long, decimal?, RecordType, RefType?, string?, StructType?, RefType, object, int, string, decimal?, RecordType?>(
