...
namespace System
{
    ...
    {
        private static Result<TSuccess, TOtherFailure> InternalRecoverCatching<TOtherFailure>(
            in TFailure failure,
        ...
        private static Task<Result<TSuccess, TOtherFailure>> InternalRecoverCatchingAsync<TOtherFailure>(
            in TFailure failure,
        ...
        private static ValueTask<Result<TSuccess, TOtherFailure>> InternalRecoverCatchingValueAsync<TOtherFailure>(
            in TFailure failure,
